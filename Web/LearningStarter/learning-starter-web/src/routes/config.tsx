...
import { DomicileCreatePage } from "../pages/domiciles-page/create-page/domicile-create";
import { DomicileListingPage } from "../pages/domiciles-page/listing-page/domicile-listing";
...
export const routes = {
  ...
  domiciles: `/domicilelocations`,
  domicileCreate: `/domicilelocations/create`,
};
    ...
    <>
      ...
      <PageWrapper user={user}>
        <Switch>
          ...
          <Route path={routes.domicileCreate} exact>
            <DomicileCreatePage />
          </Route>
          <Route path={routes.domiciles} exact>
            <DomicileListingPage />
          </Route>
